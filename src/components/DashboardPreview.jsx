...
function Stat({ label, value, hint }) {
  return (
    <div className="rounded-2xl border border-gray-200 bg-white p-6">
      ...
      <div className="mt-2 text-3xl font-extrabold text-[#1C3B71]">{value}</div>
...
function Card({ title, children, footer }) {
  return (
    <div className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
      <h3 className="text-lg font-bold text-[#1F4086]">{title}</h3>
  ...
  return (
    <section className="bg-[#F3F4F6]">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16">
        <h2 className="text-3xl font-extrabold text-[#1C3B71]">Visión de impacto</h2>
        <p className="mt-2 text-[#0B1220]/80 max-w-2xl">
        ...
        <div className="mt-10 grid gap-6 md:grid-cols-2">
          ...
          <Card title="Flujo recomendado" footer="El usuario puede saltar al CTA en cualquier momento.">
            <ol className="list-decimal pl-5 space-y-2 text-[#0B1220]">
