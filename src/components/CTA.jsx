...
const CONTACT_LINES = [
  'Felipe Garan — RRPP & CTO',
  'contacto@observauto.com',
  'Santiago · 100% remoto para LatAm'
]
...
export default function CTA() {
  return (
    ...
    >
      <div
        className="absolute inset-0 bg-[radial-gradient(circle_at_bottom_right,rgba(255,255,255,0.18),transparent_60%)]"
        aria-hidden
      />
      <div className="mx-auto max-w-5xl px-6">
        ...
        >
          ...
          <div className="grid gap-12 lg:grid-cols-[1.15fr_minmax(0,1fr)] lg:items-center">
            <div>
              <p className="text-[0.72rem] font-semibold uppercase tracking-[0.36em] text-white/60">
                CTA Awareness
              </p>
              <h2 className="mt-4 text-3xl font-black leading-tight md:text-4xl">
                Solicita el demo y coordinemos la activación.
              </h2>
              ...
              <ul className="mt-6 space-y-2 text-sm leading-relaxed text-white/70">
                <li className="uppercase tracking-[0.22em] text-white/55">Contacto directo</li>
                {CONTACT_LINES.map(line => (
                  <li key={line} className="text-white/75">
                    • {line}
                  </li>
                ))}
              </ul>
            ...
            <div className="space-y-4">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="flex items-center justify-center gap-3 rounded-pill bg-white px-6 py-4 text-sm font-semibold uppercase tracking-[0.32em] text-oa-blue shadow-soft transition hover:scale-[1.02] focus:outline-none focus:ring-2 focus:ring-white/60"
              >
                <svg
              ...
              <a
                ...
                className="flex items-center justify-center gap-3 rounded-pill border border-white/40 px-6 py-4 text-xs font-semibold uppercase tracking-[0.32em] text-white transition hover:bg-white/10 focus:outline-none focus:ring-2 focus:ring-white/60"
              >
