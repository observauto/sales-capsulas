      ...
      <div className="mx-auto max-w-4xl px-6">
        ...
        >
          ...
          <div className="grid gap-10 md:grid-cols-[1.1fr_1fr] md:items-center">
            <div>
              <h2 className="text-3xl font-extrabold md:text-4xl">Solicita el demo y coordinemos la activación.</h2>
            ...
            <div className="space-y-4">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="flex items-center justify-center gap-3 rounded-pill bg-white px-6 py-4 text-lg font-semibold text-oa-blue shadow-soft transition hover:scale-[1.02]"
              >
              ...
              <a
                ...
                className="flex items-center justify-center gap-3 rounded-pill border border-white/40 px-6 py-4 text-base font-semibold text-white transition hover:bg-white/10"
              >
