    ...
    <section id="demo-contacto" className="relative bg-oa-blue py-20">
      <div className="mx-auto max-w-3xl px-6 text-center text-white">
        ...
        <div className="mt-8 flex flex-col sm:flex-row gap-3 justify-center">
          ...
          <a href="https://wa.me/573053500400" target="_blank" rel="noreferrer" className="rounded-pill border border-white/70 px-6 py-3 font-semibold hover:bg-white/10 transition">Escribirme a WhatsApp</a>
        </div>
