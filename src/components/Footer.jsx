...
export default function Footer() {
  ...
  return (
    <footer className="mt-24 border-t border-[color:var(--oa-border)] bg-white/90 backdrop-blur">
      <div className="container py-12">
        ...
        <div className="mt-10 flex flex-col gap-3 border-t border-[color:var(--oa-border)] pt-6 text-xs uppercase tracking-[0.32em] text-gray-500 md:flex-row md:items-center md:justify-between">
          <p className="text-[0.68rem] text-gray-500">© {year} Observauto. Todos los derechos reservados.</p>
