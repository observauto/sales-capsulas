        ...
        <div className="grid grid-cols-1 gap-10 md:grid-cols-4">
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2 text-sm uppercase tracking-[0.26em] text-gray-600">
              ...
              <li>
                <a href="/#resultados" className="hover:text-gray-900">
                  Resultados
                </a>
              </li>
              <li>
                <a href="/pauta" className="hover:text-gray-900">
                  Pauta
                </a>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2 text-sm uppercase tracking-[0.26em] text-gray-600">
              <li>
                <a href="https://stats.observauto.com/pauta/" className="hover:text-gray-900" target="_blank" rel="noreferrer">
                  Guía de estilo
                </a>
              </li>
              <li>
                <a href="https://stats.observauto.com/" className="hover:text-gray-900" target="_blank" rel="noreferrer">
                  Panel de datos
                </a>
              </li>
              <li>
                <a href="https://capsulas.observauto.com/" className="hover:text-gray-900" target="_blank" rel="noreferrer">
                  Sitio histórico
                </a>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2 text-sm uppercase tracking-[0.26em] text-gray-600">
              <li>
                <a href="mailto:info@observauto.com" className="hover:text-gray-900">
                  info@observauto.com
                </a>
              </li>
              <li>
