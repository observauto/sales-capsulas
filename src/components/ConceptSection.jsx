...
export default function ConceptSection() {
  return (
    <section id="concept" className="bg-white dark:bg-[#0e1526]">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="mt-10 grid gap-6 sm:grid-cols-3">
          {[
            ...
            <div key={f.title} className="rounded-2xl border border-gray-200 bg-[#F3F4F6] p-6 dark:border-white/10 dark:bg-[#111a30]">
