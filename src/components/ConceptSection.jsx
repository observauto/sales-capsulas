    ...
    <section id="concept" className="bg-white dark:bg-[#0B1220]">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16">
        <div className="max-w-3xl">
          ...
          <p className="mt-4 text-lg text-[#0B1220] dark:text-white/80">Un módulo de conocimiento, estático y optimizado para móviles, que resuelve una duda concreta del usuario en menos de 90 segundos. Información verificada y accionable para ayudar a vender mejor y más rápido.</p>
        </div>
        <div className="mt-10 grid gap-6 sm:grid-cols-3">
          {[
            ...
            <div key={f.title} className="rounded-2xl border border-gray-200 bg-[#F3F4F6] p-6 dark:border-white/10 dark:bg-white/5">
