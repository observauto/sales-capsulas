...
export default function HeroAwareness() {
  return (
    <section className="relative overflow-hidden">
      <div className="absolute inset-0 bg-gradient-to-br from-[#1C3B71] via-[#1F4086] to-[#0b1220] opacity-95 dark:opacity-100" aria-hidden="true" />
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-24">
        <div className="max-w-3xl text-white">
          ...
          <div className="mt-8 flex flex-wrap items-center gap-3">
            <a href="#cta" data-oa="cta-primary" className="inline-flex items-center gap-2 rounded-xl bg-[#D70102] px-5 py-3 text-white font-semibold shadow-lg hover:shadow-xl transition focus:outline-none focus:ring-2 focus:ring-[#1F4086] focus:ring-offset-2">
              Explorar el demo
              <ArrowRight className="h-5 w-5" aria-hidden="true" />
            </a>
            <a href="#concept" className="inline-flex items-center rounded-xl border border-white/30 px-5 py-3 text-white hover:bg-white/10 transition focus:outline-none focus:ring-2 focus:ring-[#1F4086] focus:ring-offset-2">
              Cómo funciona
            </a>
          </div>
