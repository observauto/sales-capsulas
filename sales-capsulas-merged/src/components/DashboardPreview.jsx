  ...
  return (
    <section className="bg-[#F3F4F6] dark:bg-[#0B1220]">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16">
        ...
        <p className="mt-2 text-[#0B1220]/80 dark:text-white/70 max-w-2xl">Un vistazo a cómo las cápsulas mueven awareness e intención.</p>
        ...
        <div className="mt-10 grid gap-6 md:grid-cols-2">
          <Card title="Top cápsulas (demo)" footer="Fuente: ObservAuto (demo). Integraremos tus métricas reales.">
